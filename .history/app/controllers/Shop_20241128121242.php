...
class Shop extends Controller {
    ...
    public function processPayment() {
        if (!isLoggedIn() || !$this->isAjaxRequest()) {
        ...
        try {
            ...
            $orderData = [
                ...
                'status' => 'pending',
                'total_amount' => $this->cartModel->getCartTotal($_SESSION['user_id']) + 500, // Including shipping
            ...
            foreach ($cartItems as $item) {
                ...
                if (!$this->orderModel->addOrderItem($orderItemData)) {
