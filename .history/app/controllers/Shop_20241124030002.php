    ...
    public function createCheckoutSession() {
        ...
        try {
                ...
                $line_items[] = [
                    'price_data' => [
                        ...
                        'product_data' => [
                            ...
                            'description' => $item->weight . $item->weight_unit,
            ...
            $session = \Stripe\Checkout\Session::create([
                ...
                'mode' => 'payment',
                'success_url' => URLROOT . '/shop/checkout/success?session_id={CHECKOUT_SESSION_ID}',
                'cancel_url' => URLROOT . '/shop/cart',
                'customer_email' => $_SESSION['user_email'] // Assuming you store user email in session
            ]);

            die(json_encode(['id' => $session->id]));
        } catch(Exception $e) {
