...
class Shop extends Controller {
    ...
    public function checkout() {
        ...
        // Compile shipping address from form fields
        $shippingAddress = [
        ...
        foreach ($shippingAddress as $key => $value) {
            if (empty($value)) {
                flash('cart_message', 'All shipping address fields are required', 'alert alert-danger');
                redirect('shop/cart');
            }
        }
        ...
        try {
            // Pass user_id and shipping_address as required by your M_Order model
            $orderId = $orderModel->createOrder($_SESSION['user_id'], json_encode($shippingAddress));
