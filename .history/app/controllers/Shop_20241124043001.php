...
class Shop extends Controller {
    ...
    public function checkout() {
        ...
        $shippingFee = 500.00; // Fixed shipping fee
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $orderData = [
                ...
                'payment_method' => 'stripe', // or any other payment method
            ...
            if ($orderId) {
                ...
                flash('checkout_message', 'Failed to create order. Please try again.', 'alert alert-danger');
            }
        }
    ...
    public function initiateCheckout() {
        ...
        try {
            ...
            $shipping = 500.00; // Fixed shipping fee
