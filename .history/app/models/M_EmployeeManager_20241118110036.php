...
class M_EmployeeManager {
    ...
    public function getRecentLeaves() {
        $this->db->query("SELECT l.*, 
                          ...
                          u.first_name,
                          u.last_name,
                          CONCAT(e.first_name, ' ', e.last_name) as reviewed_by_name
                          FROM leaves l
                          JOIN leave_types lt ON l.leave_type_id = lt.id
                          JOIN users u ON l.user_id = u.user_id
                          LEFT JOIN employees e ON l.reviewed_by = e.employee_id
    ...
    // You might also want a method to get all leave types
    public function getLeaveTypes() {
        $this->db->query("SELECT id, name, max_days_per_year, description 
                          FROM leave_types 
                          WHERE max_days_per_year IS NOT NULL 
                          ORDER BY id");
