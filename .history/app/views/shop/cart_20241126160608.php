...
<!-- Add CSS link if not already in header -->
                ...
                <?php foreach($data['cart_items'] as $item): ?>
                    <div class="cart-item">
                        ...
                        <div class="quantity-input-group">
                            <button class="quantity-btn minus" onclick="updateQuantity(<?php echo $item->id; ?>, 'decrease')">
                            ...
                            <input type="number" 
                                   ...
                                   onchange="validateQuantity(this, <?php echo $item->stock; ?>)">
                            <button class="quantity-btn plus" onclick="updateQuantity(<?php echo $item->id; ?>, 'increase')">
...
<script>
    // Define URLROOT for JavaScript use
