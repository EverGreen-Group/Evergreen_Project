        ...
        <div class="cart-items">
            ...
            <?php else: ?>
                ...
                <div class="cart-summary">
                    ...
                    <button onclick="proceedToCheckout(<?php echo $subtotal; ?>)" 
                            class="btn-checkout">Proceed to Checkout (LKR <?php echo number_format($subtotal, 2); ?>)</button>
                </div>
            <?php endif; ?>
        </div>
    </div>
...
async function proceedToCheckout(amount) {
    try {
        // Show loading state
        ...
        const response = await fetch(`${URLROOT}/shop/createCheckoutSession`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            }
