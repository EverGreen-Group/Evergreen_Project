    ...
    <div class="cart-container">
        ...
        <?php else: ?>
            ...
            <div class="cart-summary">
                ...
                <button onclick="initiateCheckout()" class="btn-checkout">
...
async function initiateCheckout() {
    try {
        ...
        const response = await fetch(`${URLROOT}/shop/createOrder`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            }
        ...
        if (result.success) {
            ...
            window.location.href = `${URLROOT}/shop/payment/${result.order_id}`;
        } else {
...
function showToast(message, type = 'success') {
    Toastify({
        ...
        gravity: "top",
        position: "right",
        backgroundColor: type === 'success' ? "var(--green)" : "var(--danger)",
        stopOnFocus: true
    }).showToast();
}
</script>
