<?php 
require_once APPROOT . '/helpers/UserHelper.php';
    ...
    <div class="product-detail-container">
        <div class="product-gallery">
            <div class="main-image">
                <?php 
                $images = !empty($data['product']->images) ? 
                         explode(',', $data['product']->images) : 
                         ['default.jpg']; // Provide a default image
                ?>
                <img src="<?php echo URLROOT; ?>/img/products/<?php echo $images[0]; ?>" 
        ...
        <div class="product-info">
            <div class="product-header">
                ...
                <div class="product-meta">
                    <span class="sku">SKU: <?php echo htmlspecialchars($data['product']->sku ?? 'N/A'); ?></span>
                    <div class="rating">
                        <?php 
            ...
            <div class="product-price">
                <h3>Rs. <?php echo number_format($data['product']->price ?? 0, 2); ?></h3>
                <?php if(($data['product']->stock ?? 0) > 0): ?>
                    <span class="stock in-stock">
                        <i class='bx bx-check-circle'></i> In Stock
                        (<?php echo $data['product']->stock; ?> available)
                    </span>
                <?php else: ?>
            ...
            <div class="product-description">
                ...
                <p><?php echo htmlspecialchars($data['product']->description ?? 'No description available.'); ?></p>
            </div>
