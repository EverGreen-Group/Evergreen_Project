...
<main>
    ...
    <div class="product-detail-container">
        <div class="product-gallery">
            <div class="main-image">
                ...
                $primaryImage = $data['product']->primary_image ?? $defaultImage;
                ?>
                <img src="<?php echo URLROOT; ?>/img/products/<?php echo htmlspecialchars($primaryImage); ?>" 
                     alt="<?php echo htmlspecialchars($data['product']->product_name); ?>" 
                     id="mainImage">
            </div>
            
            <?php 
            $images = $data['product']->images ? explode(',', $data['product']->images) : [];
            if(count($images) > 1): 
            ?>
                <div class="thumbnail-images">
                    <?php foreach($images as $image): ?>
                        <img src="<?php echo URLROOT; ?>/img/products/<?php echo htmlspecialchars($image); ?>" 
                             alt="Thumbnail" 
    ...
    <?php if(isAdmin()): ?>
        <div class="image-upload-section">
            ...
            <form action="<?php echo URLROOT; ?>/admin/uploadProductImage" 
                  method="POST" 
