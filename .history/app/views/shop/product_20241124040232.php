    ...
    <div class="modal-content">
        ...
        <div class="quick-view-container">
            ...
            <div class="quick-view-details">
                ...
                <a href="<?php echo URLROOT; ?>/shop/view/" id="quickViewFullDetails" class="btn-view-details">
                    View Full Details
                </a>
            </div>
        </div>
...
async function showQuickView(productId) {
    try {
        ...
        if (product) {
            ...
            document.getElementById('quickViewFullDetails').href = 
                `${URLROOT}/shop/view/${product.id}`;
