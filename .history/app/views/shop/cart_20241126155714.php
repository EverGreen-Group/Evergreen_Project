                    ...
                    <div class="cart-item">
                        <div class="product-info">
                            ...
                            <div>
                                ...
                                <small><?php echo $item->weight; ?>g</small>
                            </div>
                        </div>
                        ...
                        <div class="quantity-controls">
                            <button class="qty-btn minus" onclick="updateQuantity(<?php echo $item->id; ?>, 'decrease')">
                                <i class='bx bx-minus'></i>
                            </button>
                            <span class="qty"><?php echo $item->quantity; ?></span>
                            <button class="qty-btn plus" onclick="updateQuantity(<?php echo $item->id; ?>, 'increase')">
                                <i class='bx bx-plus'></i>
                            </button>
                        </div>
                        
                        <div class="total">LKR <?php echo number_format($item->price * $item->quantity, 2); ?></div>
