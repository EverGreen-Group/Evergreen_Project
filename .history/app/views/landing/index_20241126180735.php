...
<main class="landing-page">
    <!-- Hero Section -->
    <section class="hero" id="hero" style="background-image: url('<?php echo URLROOT; ?>/img/categories/factory_landscape.png');">
    ...
    <section class="categories">
        ...
        <div class="category-grid">
            <a href="<?php echo URLROOT; ?>/shop/category/black-tea" class="category-card">
            ...
            <a href="<?php echo URLROOT; ?>/shop/category/green-tea" class="category-card">
                <div class="category-image">
