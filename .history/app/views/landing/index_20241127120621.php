...
<main class="landing-page">
    ...
    <!-- Tea Regions Section -->
    <section class="tea-regions">
        <div class="container">
            <h2 class="section-title">The 5 Regions of Ceylon Tea</h2>
            
            <div class="regions-map-container">
                <div class="map-side">
                    <img src="<?php echo URLROOT; ?>/img/sri-lanka-map.png" alt="Sri Lanka Tea Regions Map" class="sl-map">
                    <div class="region-markers">
                        <span class="marker" data-region="kandy"></span>
                        <span class="marker" data-region="dimbula"></span>
                        <span class="marker" data-region="nuwara-eliya"></span>
                        <span class="marker" data-region="uva"></span>
                        <span class="marker" data-region="ruhuna"></span>
                    </div>
                </div>
                
                <div class="regions-info">
                    <div class="region-tabs">
                        <button class="tab-btn active" data-region="kandy">Kandy</button>
                        <button class="tab-btn" data-region="dimbula">Dimbula</button>
                        <button class="tab-btn" data-region="nuwara-eliya">Nuwara Eliya</button>
                        <button class="tab-btn" data-region="uva">Uva</button>
                        <button class="tab-btn" data-region="ruhuna">Ruhuna</button>
                    </div>
                    
                    <div class="region-content">
                        <div class="region-details active" id="kandy">
                            <div class="tea-image">
                                <img src="<?php echo URLROOT; ?>/img/teas/kandy-tea.png" alt="Kandy Tea">
                            </div>
                            <div class="tea-info">
                                <h3>Kandy</h3>
                                <p>Grown in the ancient city of Kandy, the cultural capital of Sri Lanka, this mid-country tea provides a one of a kind appealing flavour. A dark golden liquor with full bodied strong characters, Kandy teas are grown at 2,000 – 4,000 feet above sea level. A tea which can be enjoyed with a touch of cream and sweetener as a relaxing all day beverage.</p>
                            </div>
                        </div>
                        <!-- Add similar divs for other regions -->
                    </div>
                </div>
            </div>
        </div>
