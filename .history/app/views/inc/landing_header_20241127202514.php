...
<body>
    <nav class="landing-nav">
        ...
        <div class="nav-links">
            ...
            <a href="<?php echo URLROOT; ?>/landing/about">About</a>
            <a href="<?php echo URLROOT; ?>/landing/contact">Contact</a>
            <a href="<?php echo URLROOT; ?>/landing/blog">Blog</a>
            <?php if(isset($_SESSION['user_id'])): ?>
                <a href="<?php echo URLROOT; ?>/auth/profile">Profile</a>
