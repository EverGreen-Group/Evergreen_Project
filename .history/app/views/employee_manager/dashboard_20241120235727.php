            ...
            <table>
                ...
                <tbody>
                    <?php foreach($data['recent_leaves'] as $leave): ?>
                        <tr>
                        <td><?php echo isset($leave->first_name) ? htmlspecialchars($leave->first_name . ' ' . $leave->last_name) : 'N/A'; ?></td>
                        <td><?php echo isset($leave->leave_type) ? htmlspecialchars($leave->leave_type) : 'N/A'; ?></td>
                        ...
                        <td>
                            ...
                            if ($leave->reviewed_by) {
                                echo isset($leave->reviewer_first_name) ? 
                                    htmlspecialchars($leave->reviewer_first_name . ' ' . $leave->reviewer_last_name) : 
                                    'N/A';
                            } else {
                                echo 'Pending Review';
                            }
