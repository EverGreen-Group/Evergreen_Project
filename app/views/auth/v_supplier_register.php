                ...
                <form id="supplierRegForm" action="<?php echo URLROOT; ?>/auth/supplier_register" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-step" data-step="1">
                        <div class="auth-form-group">
                            ...
                            <small class="input-help">Sri Lankan mobile number</small>
                        </div>
                    ...
                    <div class="form-step" data-step="3">
                        <div class="auth-form-row">
                            ...
                            <div class="auth-form-group">
                                ...
                                <input type="number" id="ownership_duration" name="ownership_duration" 
                    ...
                    <div class="form-step" data-step="4">
                        <div class="auth-form-row">
                            <div class="auth-form-group">
                                ...
                                <input type="number" id="totalLandArea" name="totalLandArea" 
                            ...
                            <div class="auth-form-group">
                                ...
                                <input type="number" id="teaCultivationArea" name="teaCultivationArea" 
                                       min="0.25" step="0.25" required>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="auth-form-row">
                                ...
                                <div class="auth-form-group">
                                    ...
                                    <input type="file" id="ownership_proof" name="ownership_proof" accept=".pdf" required>
                            ...
                            <div class="auth-form-row">
                                <div class="auth-form-group">
                                    ...
                                    <input type="file" id="tax_receipts" name="tax_receipts" accept=".pdf,.jpg,.jpeg,.png" required>
                                    <small class="input-help">Upload latest tax payment receipts (Max: 5MB)</small>
                                </div>
                                <div class="auth-form-group">
                                    <label for="bank_passbook">Bank Passbook Copy</label>
                                    <input type="file" id="bank_passbook" name="bank_passbook" accept=".jpg,.jpeg,.png" required>
                            ...
                            <div class="auth-form-group">
                                ...
                                <input type="file" id="grama_cert" name="grama_cert" accept=".pdf,.jpg,.jpeg,.png" required>
