...
<main>
    ...
    <div class="update-form-container">
        ...
        <form action="<?php echo URLROOT; ?>/suppliermanager/updateSupplier/<?php echo $data['user_id']; ?>" method="POST" class="request-form">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="nic" name="nic" 
                            ...
                            class="<?php echo (!empty($data['nic_err'])) ? 'is-invalid' : ''; ?>">
