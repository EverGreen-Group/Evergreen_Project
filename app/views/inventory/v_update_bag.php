...
<main>
    <div class="head-title">
        <div class="left">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="<?= URLROOT ?>/inventory/viewAwaitingInventory/<?= $data['bag']->collection_id ?>">Collection Bags</a></li>
                <li><i class='bx bx-chevron-right'></i></li>
    ...
    <form id="updateBagForm" method="POST" action="<?php echo URLROOT; ?>/inventory/updateBag/<?php echo $data['bag']->history_id; ?>">
        ...
        <div class="order">
            ...
            <div class="section-content">
                ...
                <div class="info-row">
                    ...
                    <input type="number" step="0.01" id="actual_weight_kg" name="actual_weight_kg" class="form-control" 
                           value="<?= $data['bag']->actual_weight_kg ?>" required>
                </div>
                <div class="info-row">
                    ...
                    <select id="leaf_age" name="leaf_age" class="form-control" required>
                        ...
                        <option value="Young" <?= ($data['bag']->leaf_age == 'Young') ? 'selected' : ''; ?>>Young</option>
                        <option value="Medium" <?= ($data['bag']->leaf_age == 'Medium') ? 'selected' : ''; ?>>Medium</option>
                        <option value="Mature" <?= ($data['bag']->leaf_age == 'Mature') ? 'selected' : ''; ?>>Mature</option>
                    </select>
                </div>
                <div class="info-row">
                    ...
                    <select id="moisture_level" name="moisture_level" class="form-control" required>
                        ...
                        <option value="Wet" <?= ($data['bag']->moisture_level == 'Wet') ? 'selected' : ''; ?>>Wet</option>
                        <option value="Semi Wet" <?= ($data['bag']->moisture_level == 'Semi Wet') ? 'selected' : ''; ?>>Semi Wet</option>
                        <option value="Dry" <?= ($data['bag']->moisture_level == 'Dry') ? 'selected' : ''; ?>>Dry</option>
                    </select>
                </div>
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <textarea id="deduction_notes" name="deduction_notes" class="form-control" rows="4"><?= $data['bag']->deduction_notes ?></textarea>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="order">
            ...
            <div class="section-content">
                ...
                <div class="info-row">
                    ...
                    <span class="value"><?= 'C' . str_pad($data['bag']->collection_id, 3, '0', STR_PAD_LEFT) ?></span>
                </div>
                <div class="info-row">
    ...
    <div class="button-group">
        ...
        <a href="<?= URLROOT ?>/inventory/viewAwaitingInventory/<?= $data['bag']->collection_id ?>" class="btn btn-secondary">Cancel</a>
    </div>
    </form>
