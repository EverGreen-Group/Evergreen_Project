...
<body>
    ...
    <div class="fc-body">
        <div class="form-container">
            ...
            <form action="<?php echo URLROOT; ?>/inventory/updatefertilizer" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control">
                            ...
                            <select id="company-name" name="company_name">
                                ...
                                <option value="brown" <?php echo (isset($data['fertilizer']->company_name) && $data['fertilizer']->company_name == 'brown') ? 'selected' : ''; ?>>Brown & Company
                                </option>
                                ...
                                <option value="lankem" <?php echo (isset($data['fertilizer']->company_name) && $data['fertilizer']->company_name == 'lankem') ? 'selected' : ''; ?>>Lankem Ceylon
                                </option>
