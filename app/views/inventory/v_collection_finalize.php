    ...
    <div class="order">
      ...
      <table>
        ...
        <tbody>
            ...
            <?php foreach ($collections as $collection): ?>
              <?php if ($collection->status === 'Awaiting Inventory Addition'): ?>
                <tr>
                  ...
                  <td>
                    <a href="<?php echo URLROOT; ?>/inventory_manager/viewCollection/<?php echo htmlspecialchars($collection->collection_id); ?>"
          ...
          <?php else: ?>
            <tr>
              <td colspan="7" style="text-align:center;">No collections awaiting inventory addition</td>
            </tr>
          <?php endif; ?>
        </tbody>
      </table>
...
<style>
  ...
  .awaiting-inventory {
    ...
    /* Gold color for awaiting status */
    color: #000;
    /* Black text */
  }
</style>
