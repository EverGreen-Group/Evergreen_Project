...
<script src="<?php echo URLROOT; ?>/public/js/inventory_manager/export.js"></script>
...
<main>
  ...
  <div class="action-buttons">
      <button class="btn btn-primary" onclick="addExportRecord()">
                ...
                <div class="vehicle-modal-details">
                    <div class="detail-group">
                        ...
                        <div class="detail-row">
                            ...
                            <span class="value">23</span> <!-- This could be dynamically generated -->
                        </div>
                        <div class="detail-row">
                            <span class="label">Tea Type:</span>
                            <span class="value">
                                <select id="exportTeaType" name="tea_type" required style="width: 100%; padding: 8px; box-sizing: border-box;">
                        ...
                        <div class="detail-row">
                            ...
                            <span class="value">
                                <select id="exportGrading" name="grading" required style="width: 100%; padding: 8px; box-sizing: border-box;">
                        ...
                        <div class="detail-row">
                            ...
                            <span class="value">
                                <input type="number" id="exportQuantity" name="quantity" required style="width: 100%; padding: 8px; box-sizing: border-box;">
                            </span>
                        </div>
                        <div class="detail-row">
                            <span class="label">Price per kg ($):</span>
                            <span class="value">
                                <input type="number" id="exportPrice" name="price_per_kg" required style="width: 100%; padding: 8px; box-sizing: border-box;" step="0.01">
                            </span>
                        </div>
                        <div class="detail-row">
                            <span class="label">Company:</span>
                            <span class="value">
                                <input type="text" id="exportCompany" name="company" required style="width: 100%; padding: 8px; box-sizing: border-box;">
                            </span>
                        </div>
                        <div class="detail-row">
                            <span class="label">Notes:</span>
                            <span class="value">
                                <textarea id="exportNotes" name="notes" rows="3" style="width: 100%; padding: 8px; box-sizing: border-box;"></textarea>
                            </span>
                        </div>
                    </div>
                </div>
                <div style="text-align: center; margin-top: 20px;">
                    <button type="submit" class="btn btn-primary full-width" onclick="addExportRecord(event)">ADD EXPORT RECORD</button>
                </div>
            </div>
        </div>
    </div>
