        ...
        <main>
            ...
            <div class="table-data">
                <div class="order">
                    ...
                    <div class="buttons">
                        <a href="EditProfile.php?id=$row['supplier_id']">
...
<!--
    <td><label for="fullname">Full Name:</label></td>
    <td><input type="text" id="fullname" name="fullname" class="input" readonly></td>
    </tr>
    <tr>
    <td><label for="address">Address:</label></td>
    <td><input type="text" id="address" name="address" class="input" readonly></td>
    </tr>
    <tr>
    <td><label for="email">Email:</label></td>
    <td><input type="text" id="email" name="email" class="input" readonly></td>
    </tr>
    <tr>
    <td><label for="contact">Contact:</label></td>
    <td><input type="text" id="contact" name="contact" class="input" readonly></td>
    </tr>
    <tr>
    <td><label for="supplierid">Supplier ID:</label></td>
    <td><input type="text" id="supplierid" name="supplierid" class="input" readonly></td>
    </tr>
    <tr>
    <td><label for="route">Route No:</label></td>
    <td><input type="text" id="route" name="route" class="input" readonly></td>
    </tr>
    <tr>
    <td><label for="date">Registered Date:</label></td>
    <td><input type="date" id="date" name="date" class="input" readonly></td> -->
