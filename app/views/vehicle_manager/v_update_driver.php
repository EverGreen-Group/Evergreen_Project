...
<main>
    ...
    <form id="createDriverForm" method="POST" action="<?php echo URLROOT; ?>/vehiclemanager/updateDriver" enctype="multipart/form-data">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    userSelect.addEventListener('change', function() {
        ...
        const userId = selectedOption.value; // Get the selected user ID
        ...
        if (userId) {
            ...
            // Fetch driver information based on the selected user ID
            fetch(`<?php echo URLROOT; ?>/vehiclemanager/getEmployeeByUserId/${userId}`)
