...
function calculatePrices() {
  ...
  if (typeSelect.value && unitSelect.value && totalAmountInput.value) {
    ...
    totalPriceInput.value = (
      unitPrice * parseFloat(totalAmountInput.value)
    ).toFixed(2);
  }
}
...
const income = [
  5000, 7000, 8000, 10000, 12000, 14000, 13000, 11000, 15000, 16000, 18000,
  20000,
];
const cost = [
  3000, 4000, 5000, 6000, 700, 8000, 7500, 6000, 9000, 200, 12000, 13000,
];
...
function updatePrice() {
  ...
  totalPriceInput.value = (
    pricePerUnit * parseFloat(amountInput.value)
  ).toFixed(2);
}
